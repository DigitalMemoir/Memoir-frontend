...
const Detail = forwardRef<HTMLDivElement, DetailProps>(
  ({ dateString }, ref) => {
    const activities = {
      ...
      activityProportions: [
        { category: '업무, 프로젝트', percentage: 27 },
        { category: '공부, 학습', percentage: 65 },
        { category: '쇼핑', percentage: 8 },
      ],
    };
    ...
    const dailyTimeline = [
      ...
      { time: '17:00', description: '쿠팡에서 개발자 장비 특가 확인' },
      { time: '19:00', description: 'Notion을 이용한 프로젝트 회의록 작성' },
    ];
